...
def vbb_anno2dict(vbb_file, cam_id):
    ...
    for frame_id, obj in enumerate(objLists):
        if len(obj) > 0:
            frame_name = str(cam_id) + "_" + str(filename) + "_" + str(frame_id+1) + ".jpeg"
...
def main():
    vbb_inputdir = r"/media/yons/DATA/data/Caltech_origin/annotations"
    vbb_outputdir = r"/media/yons/DATA/data/Caltech/Annotations"
    ...
    # xml_file = r"D:\Caltech\VOC2007\Annotations\001166.xml"
    # img_file = r"D:\Caltech\VOC2007\JPEGImages\001166.jpeg"
